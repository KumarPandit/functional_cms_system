    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $comment_draft_count = mysqli_num_rows($select_all_unapproved_comment);
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        ...
                        ['Data','Count'],
                            ...
                            $element_count = [$post_counts,$post_published_count,$post_draft_count,$comments_counts,$comment_draft_count,$users_counts,$subscriber_count,$categories_counts];
                            for($i =0; $i < 7 ; $i++) {
